...
{     
   ...
   */
    public CardWar(int rank, int suit) 
    {
        this.rank = rank;
        this.suit = suit;
    }
   ...
   */
    public CardWar(CardWar otherCard) 
    {
   ...
   */
   public String getRankAsString() 
   {
        switch ( rank ) {
           ...
           case 13:  return "King";
           default:  return "King";   //modified to satisfy deck class
        }
    }
   /**
   ...
   * falseotherwise.
   */
   public boolean equals(CardWar otherCard ) 
   {
